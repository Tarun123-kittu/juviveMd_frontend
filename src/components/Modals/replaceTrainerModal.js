        ...
        >
          <div className="modal_head text-end">
            ...
            <Modal.Body className='p-0'>
                ...
                <p className='trainer_delete'>The trainer you are trying to delete has created {exerciseCount} {exerciseCount > 1 ? "exercises" : "exercise"}. Please assign {exerciseCount > 1 ? "these" : "this"} {exerciseCount > 1 ? "exercises" : "exercise"} to a new trainer before proceeding.</p>
               ...
               <div className='d-flex justify-content-end gap-3 mt-3'>
                <button className='btn cmn_btn border-btn' onClick={() => handleClose()}>Cancel</button>
