...
const EmailSentModal = ({ showEmailSentModal, setShowEmailSentModal}) => {
    const handleClose = () => {
    ...
    return (
        <div>
            <Modal size={"md"} show={showEmailSentModal} onHide={handleClose} className="cmn_modal EmailSentModal" centered size="md">
                ...
                <Modal.Body className="p-0">
                    ...
                    <h5 className="deletmodal_heading mt-4 text-center">
