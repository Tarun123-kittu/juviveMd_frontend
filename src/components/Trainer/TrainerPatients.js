                                    ...
                                    <tr>
                                        ...
                                        <td className='text-center'>
                                            <div className="d-flex justify-content-between w-100 gap-2">
                                             ...
                                             { PatientPlan?.canRead &&  <button onClick={() => navigate("/trainer/patient/patientData", { state: { patientId: patient?.id } })} className='cmn_btn px-2 py-1' style={{ height: "36px" }}> <img width="18" src={ArrowRight} /> </button>}
                                            </div>
                                        </td>
                                    </tr>
                                )
