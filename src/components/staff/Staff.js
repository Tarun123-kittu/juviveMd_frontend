...
const StaffComponent = () => {
    ...
    return (
        <div className="wrapper">
                ...
                <div className="cmn_table dark_btn">
                    <DataTable columns={columns} hasCheckbox={true}>
                        <tr>
                            ...
                            <td>+146975234</td>
                            <td>Male</td>
                            <td><button className="btn_info active">Active</button></td>
                            <td>@mdo</td>
                        </tr>
                        <tr>
                            <td> <Form.Check className="ms-2" aria-label="option 1" /></td>
                            ...
                            <td>+146975234</td>
                            <td>Male</td>
                            <td><button className="btn_info inactive">Inactive</button></td>
                            <td>
                                <div className="d-flex justify-content-between w-100">
                                    <svg onClick={() => setShowEditModal(true)} width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <svg onClick={()=>setshowDeleteModal(true)} className="me-3" width="22" height="24" viewBox="0 0 22 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <EditStaffmodal show={showEditModal} setShow={setShowEditModal}/>
        </div>
    )
}
