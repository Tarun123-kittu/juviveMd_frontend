    ...
    const handleStaffDelete = (id, role) => {
        if (role === "TRAINER") {
            ...
            if (Object.keys(findExercises)) {
                if (findExercises?.totalExercises > 0) {
                                    ...
                                    <tr key={i}>
                                        ...
                                        <td>
                                            <div className="d-flex justify-content-between w-100">
                                                ...
                                                {firstPermission?.canDelete && <svg onClick={() => handleStaffDelete(staff?.id, staff?.role)} className="me-3" width="22" height="24" viewBox="0 0 22 24" fill="none" xmlns="http://www.w3.org/2000/svg">
