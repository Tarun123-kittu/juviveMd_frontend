...
import MobilityProgressChart from "./MobilityProgressChart";
const PatientReport = () => {
...
const trainingType = location.state.trainingType
  ...
  const getTrainingType = useSelector((state) => state.GET_TRAINER_TYPE_REPORT)
  const weightProgressData = useSelector((state) => state.GET_WEIGHT_REPORT)
  const progressFactorData = useSelector((state) => state.GET_PROGRESS_FACTOR)
  ...
  console.log("getTrainingTypegetTrainingType", getTrainingType)
  console.log("trainingType", trainingType)
  console.log("progressFactorDataout", progressFactorData)
  console.log("weightProgressData---in", weightProgressData)
    ...
    <div className="wrapper">
      <div className="inner_wrapper">
        ...
        <Row className="row-gap-3">
          ...
          <WeightProgressChart weightProgressData={weightProgressData?.data?.data}  patientId={patientId}/>
            </div>
          </Col>
          <Col lg={3}>
            <div className="cmn_card h-100">
          ...
          <Col lg={6}>
          <div className="cmn_card h-100">
          <TrainingTypeDistribution patientId={patientId} getTrainingType={getTrainingType?.data?.data}  />
            </div>
          </Col>
          <Col lg={6}>
            <div className="cmn_card">
              ...
              <MobilityProgressChart progressFactorData={progressFactorData?.data} trainingType={trainingType} patientId={patientId} />
